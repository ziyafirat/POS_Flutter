...
class LanguageController extends GetxController {
  ...
  String get callHelp => isEnglish ? 'Call for Assistance' : 'طلب المساعدة';
  String get finishAndPay => isEnglish ? 'Finish & Pay' : 'إنهاء ودفع';
  String get addTestItem => isEnglish ? 'Add Test Item' : 'إضافة عنصر تجريبي';

  // Payment page texts
  String get makeSelection =>
      isEnglish ? 'Make Your Selection Now' : 'اختر الآن';
  String get cash => isEnglish ? 'Cash' : 'نقداً';
  String get credit => isEnglish ? 'Credit' : 'ائتمان';
  String get paymentWithChange =>
      isEnglish ? 'Payment with Change' : 'دفع مع الباقي';
  String get paymentWithStaffCard =>
      isEnglish ? 'Payment with Staff Card' : 'دفع ببطاقة الموظف';
  String get returnScanMore =>
  ...
  String get cardPaymentProcessing =>
      isEnglish ? 'Card Payment Processing' : 'معالجة دفع البطاقة';
  String get pleaseTapOrInsertCard =>
      isEnglish ? 'Please tap or insert your card' : 'يرجى لمس أو إدخال بطاقتك';
  String get processingYourPayment =>
      isEnglish ? 'Processing your payment...' : 'جاري معالجة دفعتك...';
  String get cardHolder => isEnglish ? 'CARD HOLDER' : 'حامل البطاقة';

  // Item list texts
  String get noItemsScanned =>
      isEnglish ? 'No items scanned yet' : 'لم يتم مسح أي عناصر بعد';
  ...
  String get campaignDiscount =>
      isEnglish ? 'Campaign Discount:' : 'خصم الحملة:';
  ...
  String get welcomeTitle =>
      isEnglish ? 'Welcome to Self-Checkout' : 'مرحباً بك في الدفع الذاتي';

  String get welcomeSubtitle =>
      isEnglish ? 'ALMAYA SUPERMARKET' : 'يرجى مسح عناصرك للبدء';

  String get startShopping =>
      isEnglish ? 'Please scan your items to begin' : 'يرجى مسح عناصرك للبدء';

  String get assistant => isEnglish ? 'Assistant' : 'المساعد';

  // Printing page texts
  String get thankYouForShopping =>
      isEnglish ? 'Thank you for shopping!' : 'شكراً لك على التسوق!';

  String get waitingForSystemResponse =>
      isEnglish ? 'Waiting for system response...' : 'انتظار استجابة النظام...';
  ...
  // Format currency with AED symbol and 2 decimal places
