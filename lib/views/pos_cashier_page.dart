...
class _PosCashierPageState extends State<PosCashierPage> {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Obx(
                                    () => Text(
                                      controller.posSubState.isNotEmpty
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  _numberInput.isEmpty
                                      ? 'Enter numbers...'
                                      : _numberInput,
                                  style: TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold,
                                    color: _numberInput.isEmpty
                                        ? Colors.grey[400]
                                        : Colors.black87,
                                  ),
                                  textAlign: TextAlign.center,
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    onPressed: _numberInput.isNotEmpty
                                        ? _clearNumberInput
                                        : null,
  ...
  void _sendApiCommand(WebApiService webApiService, String displayLine) {
    ...
    print(
      '⌨️  Number Input: "${_numberInput.isEmpty ? "(empty)" : _numberInput}"',
    );
    ...
    _logger.i(
      'Number Input: "${_numberInput.isEmpty ? "(empty)" : _numberInput}"',
    );
